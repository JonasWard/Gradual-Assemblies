...
class JointHoles(object):
    ...
    def __beam_linking(self):
        ...
        print "new dowel instance"
        for i, local_beam in enumerate(self.beam_set):
            print "index : ", i, " - ", local_beam
    ...
    def foundation_function(self, beam, ref_pl = rg.Plane.WorldXY, overlap = 250):
        ...
        if not(parallel_to_the_world_xy):
            ...
            shift_length = m.tan(angle) * beam.dy / 2 + beam.extension
            ...
            if negative_direction:
                ...
                dx_foundation = rg.Interval(- overlap + beam_.xtension, 2000)
            ...
            return foundation_breps, new_beam_line, new_line_end_pt, line_start_pt
