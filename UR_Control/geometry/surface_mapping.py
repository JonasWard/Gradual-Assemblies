...
class SurfaceSet(object):
    def __init__(self, o_srf_list = None, loop = False):
        """ initialization

        :param srf_class_list:      Empty, Organised Surface or Inemurable list of Org. Srfs. Which Define it's geometry
        ...
        self.srf_list = []
        self.__surface_add_check(o_srf_list, v_or_u_continious = 0, loop)

    def AddUSurfaceSet(self, o_srf, v_or_u_continious = 0, loop = False):
